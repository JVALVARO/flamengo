        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/flamengo_logo.png" alt="" width="75px" height="75px"> </a>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>CHOOSE TO THE <b>FLAMENGO'S</b> POPULAR DISHES</h2>
                    <p class="lead">Easiest way to order your favourite food among these different dishes</p>
                </div>
                <div class="row">
						<?php 					
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p>Bawi Padre Garcia Batangas</p>
                                    <h5>Phone: 09387038522</a></h5> </div>
                                <div class="col-xs-12 col-sm-5 additional-info color-gray">
                                    <h5>Addition informations</h5>
                                   <p>You can call us in our Facebook Page
                                   Flamen'go Burger House invites you to try our signature Grilled Burgers, delicious Pizzas, mouth wat
                                   https://www.facebook.com/profile.php?id=100064117687988
                                   </p>
                                </div>
                    </div>
                </div>
